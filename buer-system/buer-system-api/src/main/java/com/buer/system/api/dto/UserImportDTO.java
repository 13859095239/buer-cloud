...
public class UserImportDTO {
    ...
    @ExcelComment(value = "用户名不能为空，长度必须在5-50个字符之间")
    ...
    @ExcelColumnWidth(width = 15, wrapText = false)
    @ExcelComment(value = "不能为空，长度不能超过50个字符")
    ...
    @ExcelColumnWidth(width = 25, wrapText = false)
    ...
    @ExcelColumnWidth(width = 10, wrapText = false)
    @ExcelComment(value = "性别为可选字段，可选值：男,女")
    ...
    @ExcelColumnWidth(width = 30, wrapText = false)
